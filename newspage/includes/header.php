<?php 
	$title_error_404 = 'Khong tim thay trang.';
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="<?php echo $_DOMAIN ?>" class="navbar-brand">Newspage</a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<?php 
						// Lay danh sach chuyen muc cap 1
						...
						if ($db->num_rows($sql_get_list_menu_1)) {
							...
							foreach ($db->fetch_assoc($sql_get_list_menu_1, 0) as $data_menu_1) {
								...
								if ($db->num_rows($sql_get_list_menu_2)) {
									...
									echo '
										<li class="dropdown">
											<a href="'.$_DOMAIN.'category/'.$data_menu_1['url'].'" class="dropdown-toggle" data-toggle="dropdown">'.$data_menu_1['label'].' <span class="caret"></span></a>'.$sub_menu.'
										</li>
									';
								} else {
									$sub_menu = '';
									echo '
										<li>
											<a href="'.$_DOMAIN.'category/'.$data_menu_1['url'].'">'.$data_menu_1['label'].'</a>'.$sub_menu.'
										</li>';
								}
							}
						}
				...
				<ul class="nav navbar-nav navbar-right">
					<li data-toggle="model" data-target="#boxSearch"><a href="http://localhost/freetuts/PHP/Web_tin_tuc/newspage/templates/search.php"><span class="glyphicon glyphicon-search"></span></a></li>
				</ul>
			</div>
		</div>
	</nav>
